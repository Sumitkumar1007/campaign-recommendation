...
def build_query(schema: str, table: str, vertical_column: str) -> sql.Composed:
    ...
    return sql.SQL(
        ...
        """
    ).format(table_ref=table_ref, parsed_emi_date=parsed_emi_date, vertical_column=vertical_identifier)
